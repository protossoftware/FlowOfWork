 ...
 * <ul>
 *   <li>{@link de.protos.FlowOfWork.core.fow.foW.impl.ActivityRefImpl#getName <em>Name</em>}</li>
...
public class ActivityRefImpl extends MinimalEObjectImpl.Container implements ActivityRef
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FoWPackage.ACTIVITY_REF__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case FoWPackage.ACTIVITY_REF__NAME:
        return getName();
