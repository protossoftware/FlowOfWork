 ...
 * <ul>
 *   <li>{@link de.protos.FlowOfWork.core.fow.foW.ActivityRef#getName <em>Name</em>}</li>
...
public interface ActivityRef extends EObject
{
   ...
   * @see #setName(String)
   * @see de.protos.FlowOfWork.core.fow.foW.FoWPackage#getActivityRef_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link de.protos.FlowOfWork.core.fow.foW.ActivityRef#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
